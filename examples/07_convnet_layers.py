...
"""
This program is almost similar to 07-convnet-mnist-started.py, except tf.layers here instead of tf.nn
tf.layers would produce and manage parameters automatically which is more convient to tf.nn
"""
