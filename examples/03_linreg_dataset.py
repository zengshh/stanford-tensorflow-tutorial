...
#Iterates through the dataset as many times as we want. Need to initialize with each epoch. Not make_one_shot_iterator()
...
with tf.Session() as sess:
    ...
    for i in range(100):
        ...
        total_loss = 0
        #to ergodic the data set even we donn't know its size
        try:
            while True:
