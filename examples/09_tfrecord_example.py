...
def get_image_binary(filename):
    ...
    image = np.asarray(image, np.uint8) #convert image into array
    #print(image.shape) -> (510, 1020, 3)
    shape = np.array(image.shape, np.int32) #convert tuple into array
    #print(shape)  -> [510, 1020, 3]
