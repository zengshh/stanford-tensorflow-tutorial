...
class VGG(object):
    def __init__(self, input_img):
        ...
        #scipy.io.loadmat will load a .mat file, include header、data、tail. 
        #['layers'] is to get the exact data (usually array) named layers 
    ...
    def _weights(self, layer_idx, expected_layer_name):
        """ Return the weights and biases at layer_idx already trained by VGG
            Should know about self.vgg_layers firstly
        """
        ...
        assert layer_name == expected_layer_name #expected_layers_name should be strictly coresponsed to official name
    ...
    def conv2d_relu(self, prev_layer, layer_idx, layer_name):
        ...
        #coresponse to getattr(), used to set value of attribute
        #setattr(object, name, value), assign value to object.name.
    ...
    def load(self):
        self.conv2d_relu(self.input_img, 0, 'conv1_1')#layers_idx include conv, relu, pool, fc
